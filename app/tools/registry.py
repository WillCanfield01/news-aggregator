        ...
        },
        {
        ...
        },
	        {
	            ...
	            "inputs": [
	                ...
	                {
	                    "name": "uses_per_frequency",
	                    "label": "Uses per frequency",
	                    "type": "text",
	                    "required": True,
	                    "max_chars": 10,
	                ...
	                {
	                    "name": "minutes_per_use",
	                    "label": "Minutes per use",
	                    "type": "text",
	                    "required": True,
	                    "max_chars": 30,
	                    "placeholder": "60",
	                ...
	                },
	                {
	                    ...
	                    "label": "Value per hour (optional, $/hr)",
	                    "type": "text",
	                    "required": False,
	                    "max_chars": 30,
	                    "placeholder": "25",
                ...
                },
                {
                ...
                },
	                {
	                    ...
	                    "label": "Option B minutes per use",
	                    "type": "text",
	                    "required": False,
	                    "max_chars": 30,
	                    "placeholder": "45",
                ...
                },
                {
                ...
                },
	                {
	                    ...
	                    "label": "Option B value per hour (optional, $/hr)",
	                    "type": "text",
	                    "required": False,
	                    "max_chars": 30,
	                    "placeholder": "",
	        ...
	        {
	            "slug": "social-post-polisher",
	            "title": "Social Post Polisher",
	            "description": "Clean up your post and improve flow for LinkedIn, X, or Instagram.",
	            "category": "Productivity",
	            "is_enabled": True,
	            "output_label": "Polished post",
	            "inputs": [
	                {
	                    "name": "raw_post",
	                    "label": "Your post",
	                ...
	                },
	                {
	                    ...
	                    "max_chars": 20,
	                    "placeholder": "",
	                    "options": ["LinkedIn", "X (Twitter)", "Instagram", "Threads"],
	                    "default": "LinkedIn",
	                },
	                {
	                    "name": "tone",
	                ...
	                },
	                {
	                    ...
	                    "max_chars": 30,
	                    "placeholder": "",
	                    "options": ["Keep similar length", "Slightly shorter", "Much shorter"],
	                    "default": "Slightly shorter",
	                },
	                {
	                    "name": "call_to_action",
	        ...
	        },
	        {
	            "slug": "workout-log",
	            "title": "Workout Log",
	            "description": "Log workouts fast. No ads. Export CSV.",
	            "category": "Fitness",
	            "is_enabled": True,
	            "output_label": "Saved workouts",
	            "inputs": [
	                {
	                    "name": "workout_date",
	                    "label": "Date",
	        ...
	        },
	        {
	            "slug": "grocery-list",
	            "title": "Grocery List",
	            "description": "A shareable grocery list link, no app required.",
	            "category": "Home",
	            "is_enabled": True,
	            "output_label": "Your list",
	            "inputs": [
	                {
	                    "name": "list_name",
	        ...
	        },
	        {
	            "slug": "countdown",
	            "title": "Countdown",
	            "description": "Track important dates with a simple countdown.",
	            "category": "Life",
	            "is_enabled": True,
	            "output_label": "Countdown",
	            "inputs": [
	                {
	                    "name": "event_name",
	                    "label": "Event name",
	                    ...
	                    "required": True,
	                    "max_chars": 60,
	                    "placeholder": "Vacation, birthday, launch day…",
	                },
	                {
	                    "name": "event_date",
	                    "label": "Event date",
	                ...
	                },
	                {
	                    ...
	                    "max_chars": 40,
	                    "placeholder": "",
	                    "options": ["Local", "America/Boise", "UTC"],
	                    "default": "Local",
	                },
	            ],
	        },
